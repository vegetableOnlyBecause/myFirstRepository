CREATE TABLE `family_order` (
    ...
    `buyer_user_id` varchar(256) NOT NULL COMMENT '买家用户ID',
    `seller_user_id` varchar(256) NOT NULL COMMENT '卖家用户ID',
    ...
    INDEX `idx_family_order_buyer_user_id` (`buyer_user_id`) USING BTREE,
    INDEX `idx_family_order_seller_user_id` (`seller_user_id`) USING BTREE
