CREATE TABLE `commodity` (
     ...
     `original_price` decimal NOT NULL COMMENT '原始价格',
     `sale_price` decimal NOT NULL COMMENT '销售价格',
...
CREATE TABLE `commodity_category` (
      ...
      `update_time` timestamp NOT NULL DEFAULT NOW() COMMENT '更新时间',
      PRIMARY KEY (`id`),
      UNIQUE KEY `unique_idx_commodity_category_category_id` (`category_id`) USING BTREE,
      INDEX `idx_commodity_category_parent_category_id` (`parent_category_id`) USING BTREE
